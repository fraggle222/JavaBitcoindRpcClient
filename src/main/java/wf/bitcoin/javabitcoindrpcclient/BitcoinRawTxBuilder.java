...
public class BitcoinRawTxBuilder {
  ...
  public BitcoinRawTxBuilder in(double value) throws BitcoinRpcBaseException {
    return in(value, 6);
  }

  public BitcoinRawTxBuilder in(double value, int minConf) throws BitcoinRpcBaseException {
    ...
    if (v > 0)
      throw new BitcoinRpcBaseException("Not enough bitcoins (" + v + "/" + value + ")");
    return this;
  }

  private HashMap<String, BitcoindRpcClient.RawTransaction> txCache = new HashMap<>();

  private BitcoindRpcClient.RawTransaction tx(String txId) throws BitcoinRpcBaseException {
  ...
  public BitcoinRawTxBuilder outChange(String address) throws BitcoinRpcBaseException {
    return outChange(address, 0d);
  }

  public BitcoinRawTxBuilder outChange(String address, double fee) throws BitcoinRpcBaseException {
    double is = 0d;
  ...
  public String create() throws BitcoinRpcBaseException {
    return bitcoin.createRawTransaction(new ArrayList<>(inputs), outputs);
  }

  public String sign() throws BitcoinRpcBaseException {
    return bitcoin.signRawTransaction(create(), null, null);
  }

  public String send() throws BitcoinRpcBaseException {
